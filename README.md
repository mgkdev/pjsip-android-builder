...
1. Go to [OpenSSL download page](https://www.openssl.org/source/) and get the link to download the latest stable version (at the time of this writing the version is 1.0.2? and the link is: https://www.openssl.org/source/openssl-1.0.2?.tar.gz)
2. Edit `config.conf` and change: 
  ```
OPENSSL_DOWNLOAD_URL="https://www.openssl.org/source/openssl-1.0.2?.tar.gz"
OPENSSL_DIR_NAME="openssl-1.0.2?"
